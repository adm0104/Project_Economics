...
def run_econs(pars, runSettingsFrame):
    ...
    if runSettingsFrame.settings.incremental == 'Incremental':
        ...
        pbase.capex([0],[pars['pbase']['capex']])
        pbase.cash_flow()
    ...
    p10.capex(capex_months,[pars['p10']['capex']])
    p10.cash_flow()
    ...
    p50.capex(capex_months,[pars['p50']['capex']])
    p50.cash_flow()
    ...
    p90.capex(capex_months,[pars['p90']['capex']])
    p90.cash_flow()
    ...
    pfail.capex(fail_capex_months,[pars['pfail']['capex']])
    pfail.cash_flow()
